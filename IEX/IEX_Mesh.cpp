...
void iexMesh::Update(Quaternion q)
{
	Matrix MatScale;
	Matrix Tranceration;
	if (!lpMesh) return;
	...
	D3DXMatrixRotationQuaternion(&TransMatrix, &buf);*/
	...
	//上方向
	Upside.x = TransMatrix._21;
	Upside.y = TransMatrix._22;
	Upside.z = TransMatrix._23;
	Upside.Normalize();
