...
void	SYSTEM_Initialize()
{
	...
	KEYSET	keyset = { 'W', 'S', 'A', 'D', 'Z', 'X', 'C', 'V',  'A', 'Q', '1', 'S', 'W', '2', VK_RETURN, VK_SPACE, VK_NUMPAD0, VK_NUMPAD2, VK_NUMPAD4, VK_NUMPAD5, VK_NUMPAD6, VK_NUMPAD8, VK_RETURN/* ENTER */};
	KEY_Asign(keyset);
	...
	//shader = new iexShader("DATA\\SHADER\\T3D.fx");
